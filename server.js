...
const app = express();
app.use(compression()); // บีบอัด payload (Gzip) ทุก Response เพื่อลดขนาดข้อมูลที่ต้องดาวน์โหลด
...
// เสิร์ฟไฟล์สแตติกจากโฟลเดอร์ public พร้อมเปิดใช้งาน Caching 1 วัน
