-- สร้างฐานข้อมูล
CREATE DATABASE IF NOT EXISTS `family_expense` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `family_expense`;

-- 1. ตารางผู้ใช้ในครอบครัว
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `line_id` VARCHAR(255) UNIQUE DEFAULT NULL,
  `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 2. ตารางหมวดหมู่รายการ
...
-- ใส่ข้อมูลหมวดหมู่ตั้งต้น (Default Categories)
